{
  ...
  c2->cd(1);
  TH2F *h_TracksCD_Charge_neg_NDF2 = (TH2F*)_file0->Get("h_TracksCD_Charge_-1_NDF_2_topology_2");
  h_TracksCD_Charge_neg_NDF2->Draw("colz");

  c2->cd(2);
  TH2F *h_TrajCD_Charge_neg_NDF2 = (TH2F*)_file0->Get("h_TrajCD_Charge_-1_NDF_2_topology_2");
  ...
  c2_1->cd(1);
  TH2F *h_TracksCD_Charge_pos_NDF2 = (TH2F*)_file0->Get("h_TracksCD_Charge_1_NDF_2_topology_2");
  h_TracksCD_Charge_pos_NDF2->Draw("colz");

  c2_1->cd(2);
  TH2F *h_TrajCD_Charge_pos_NDF2 = (TH2F*)_file0->Get("h_TrajCD_Charge_1_NDF_2_topology_2");
  ...
  TH2F *h_Eff_0_NDF_2 = (TH2F*)h_TracksCD_Charge_neg_NDF2->Clone("Eff_0_NDF_2");
  h_Eff_0_NDF_2->Divide(h_TrajCD_Charge_neg_NDF2);
  ...
  TH2F *h_Eff_1_NDF_2 = (TH2F*)h_TracksCD_Charge_pos_NDF2->Clone("Eff_1_NDF_2");
  h_Eff_1_NDF_2->Divide(h_TrajCD_Charge_pos_NDF2);
  ...
  c3->cd(1);
  TH2F *h_TracksCD_Charge_neg_NDF3 = (TH2F*)_file0->Get("h_TracksCD_Charge_-1_NDF_3_topology_2");
  h_TracksCD_Charge_neg_NDF3->Draw("colz");

  c3->cd(2);
  TH2F *h_TrajCD_Charge_neg_NDF3 = (TH2F*)_file0->Get("h_TrajCD_Charge_-1_NDF_3_topology_2");
  ...
  c3_1->cd(1);
  TH2F *h_TracksCD_Charge_pos_NDF3 = (TH2F*)_file0->Get("h_TracksCD_Charge_1_NDF_3_topology_2");
  h_TracksCD_Charge_pos_NDF3->Draw("colz");

  c3_1->cd(2);
  TH2F *h_TrajCD_Charge_pos_NDF3 = (TH2F*)_file0->Get("h_TrajCD_Charge_1_NDF_3_topology_2");
  h_TrajCD_Charge_pos_NDF3->Draw("colz");


  c3a = new TCanvas("c3a","c3a",150,10,600,500);
  TH2F *h_Eff_0_NDF_3 = (TH2F*)h_TracksCD_Charge_neg_NDF3->Clone("Eff_0_NDF_3");
  h_Eff_0_NDF_3->Divide(h_TrajCD_Charge_neg_NDF3);
  ...
  TH2F *h_Eff_1_NDF_3 = (TH2F*)h_TracksCD_Charge_pos_NDF3->Clone("Eff_1_NDF_3");
  h_Eff_1_NDF_3->Divide(h_TrajCD_Charge_pos_NDF3);
  ...
  c4->cd(1);
  TH2F *h_TracksCD_Charge_neg_NDF4 = (TH2F*)_file0->Get("h_TracksCD_Charge_-1_NDF_4_topology_2");
  h_TracksCD_Charge_neg_NDF4->Draw("colz");

  c4->cd(2);
  TH2F *h_TrajCD_Charge_neg_NDF4 = (TH2F*)_file0->Get("h_TrajCD_Charge_-1_NDF_4_topology_2");
  ...
  c4_1->cd(1);
  TH2F *h_TracksCD_Charge_pos_NDF4 = (TH2F*)_file0->Get("h_TracksCD_Charge_1_NDF_4_topology_2");
  h_TracksCD_Charge_pos_NDF4->Draw("colz");

  c4_1->cd(2);
  TH2F *h_TrajCD_Charge_pos_NDF4 = (TH2F*)_file0->Get("h_TrajCD_Charge_1_NDF_4_topology_2");
  h_TrajCD_Charge_pos_NDF4->Draw("colz");


  c4a = new TCanvas("c4a","c4a",150,10,600,500);
  TH2F *h_Eff_0_NDF_4 = (TH2F*)h_TracksCD_Charge_neg_NDF4->Clone("Eff_0_NDF_4");
  h_Eff_0_NDF_4->Divide(h_TrajCD_Charge_neg_NDF4);
  ...
  TH2F *h_Eff_1_NDF_4 = (TH2F*)h_TracksCD_Charge_pos_NDF4->Clone("Eff_1_NDF_4");
  h_Eff_1_NDF_4->Divide(h_TrajCD_Charge_pos_NDF4);
  ...
  c5->cd(1);
  TH2F *h_TracksCD_Charge_neg_NDF5 = (TH2F*)_file0->Get("h_TracksCD_Charge_-1_NDF_5_topology_2");
  h_TracksCD_Charge_neg_NDF5->Draw("colz");

  c5->cd(2);
  TH2F *h_TrajCD_Charge_neg_NDF5 = (TH2F*)_file0->Get("h_TrajCD_Charge_-1_NDF_5_topology_2");
  ...
  c5_1->cd(1);
  TH2F *h_TracksCD_Charge_pos_NDF5 = (TH2F*)_file0->Get("h_TracksCD_Charge_1_NDF_5_topology_2");
  h_TracksCD_Charge_pos_NDF5->Draw("colz");

  c5_1->cd(2);
  TH2F *h_TrajCD_Charge_pos_NDF5 = (TH2F*)_file0->Get("h_TrajCD_Charge_1_NDF_5_topology_2");
...
//   Efficiency_1_NDF_5->Draw("colz");
  ...
  c6->cd(1);
  TH2F *h_TracksCD_Charge_neg_NDF6 = (TH2F*)_file0->Get("h_TracksCD_Charge_-1_NDF_6_topology_2");
  h_TracksCD_Charge_neg_NDF6->Draw("colz");

  c6->cd(2);
  TH2F *h_TrajCD_Charge_neg_NDF6 = (TH2F*)_file0->Get("h_TrajCD_Charge_-1_NDF_6_topology_2");
  ...
  c6_1->cd(1);
  TH2F *h_TracksCD_Charge_pos_NDF6 = (TH2F*)_file0->Get("h_TracksCD_Charge_1_NDF_6_topology_2");
  h_TracksCD_Charge_pos_NDF6->Draw("colz");

  c6_1->cd(2);
  TH2F *h_TrajCD_Charge_pos_NDF6 = (TH2F*)_file0->Get("h_TrajCD_Charge_1_NDF_6_topology_2");
...
//   Efficiency_1_NDF_6->Draw("colz");
  ...
  c7->cd(1);
  TH2F *h_TracksCD_Charge_neg_NDF7 = (TH2F*)_file0->Get("h_TracksCD_Charge_-1_NDF_7_topology_2");
  h_TracksCD_Charge_neg_NDF7->Draw("colz");


  c7->cd(2);
  TH2F *h_TrajCD_Charge_neg_NDF7 = (TH2F*)_file0->Get("h_TrajCD_Charge_-1_NDF_7_topology_2");
  ...
  c7_1->cd(1);
  TH2F *h_TracksCD_Charge_pos_NDF7 = (TH2F*)_file0->Get("h_TracksCD_Charge_1_NDF_7_topology_2");
  h_TracksCD_Charge_pos_NDF7->Draw("colz");

  c7_1->cd(2);
  TH2F *h_TrajCD_Charge_pos_NDF7 = (TH2F*)_file0->Get("h_TrajCD_Charge_1_NDF_7_topology_2");
...
//   Efficiency_1_NDF_7->Draw("colz");
  ...
  c8->cd(1);
  TH2F *h_TracksCD_Charge_neg_NDF8 = (TH2F*)_file0->Get("h_TracksCD_Charge_-1_NDF_8_topology_2");
  h_TracksCD_Charge_neg_NDF8->Draw("colz");

  c8->cd(2);
  TH2F *h_TrajCD_Charge_neg_NDF8 = (TH2F*)_file0->Get("h_TrajCD_Charge_-1_NDF_8_topology_2");
  ...
  c8_1->cd(1);
  TH2F *h_TracksCD_Charge_pos_NDF8 = (TH2F*)_file0->Get("h_TracksCD_Charge_1_NDF_8_topology_2");
  h_TracksCD_Charge_pos_NDF8->Draw("colz");

  c8_1->cd(2);
  TH2F *h_TrajCD_Charge_pos_NDF8 = (TH2F*)_file0->Get("h_TrajCD_Charge_1_NDF_8_topology_2");
